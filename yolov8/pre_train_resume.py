...
# 2. 模型配置
model_config = "afpn.yaml"  # YOLOv8 模型配置文件路径 (e.g., yolov8n.yaml)
...
def train_yolo():
    ...
    model = YOLO("./runs/detect/train/custom_yolov82/weights/last.pt")
    ...
    model.train(
        ...
        epochs=500,             # 训练轮数
        imgsz=224,             # 裁剪后图片较小，可以使用较低的输入尺寸，1472+32，要32倍数
